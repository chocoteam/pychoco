...
The concept of views in Constraint Programming is  is a mod is a logic formula defining allowed combinations of values for a set of variables (see :ref:`variables`),
